...
def render_og():
    ...
    # Accent underline above the wordmark — same width as "justanotetaker"
    # so it reads as part of the same composition.
    word_bbox = draw.textbbox((text_x, 0), "justanotetaker", font=word)
    ...
    draw.text((text_x, underline_y + 22), "justanotetaker", font=word, fill=(*TEXT, 255))
